...
const SocialIcons = {
    ...
    twitter: (
        <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
        <path d="M23.953 4.57a10 10 0 002.856-3.906a9.96 9.96 0 01-2.748.793 4.88 4.88 0 002.129-2.633c-.951.555-2.005.959-3.127 1.184a4.875 4.875 0 00-8.485 4.45C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.691.86 3.182 2.163 4.061a4.86 4.86 0 01-2.21-.616v.06a4.875 4.875 0 003.9 4.784 4.88 4.88 0 002.087.084 4.876 4.876 0 004.571 3.385 9.92 9.92 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
        </svg>
    ),
    email: (
        <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
    ...
    const isRestaurantLoggedIn = auth?.user?.role === 'restaurant_owner' && auth?.user?.id;
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="lg:pr-8">
                ...
                Your favorite food, delivered fresh and fast. Discover restaurants, explore delicious meals, and order what you love.
                </p>

                <div className="mt-6 flex items-center gap-2">
                <SocialLink href="https://facebook.com" label="Facebook" icon={SocialIcons.facebook} />
                <SocialLink href="https://instagram.com" label="Instagram" icon={SocialIcons.instagram} />
                <SocialLink href="https://twitter.com" label="Twitter" icon={SocialIcons.twitter} />
                <SocialLink href="mailto:support@foodhub.com" label="Email" icon={SocialIcons.email} />
                </div>
            </div>

            {/* Explore Section */}
            <div>
                <h3 className="text-sm font-semibold text-[color:var(--color-text-primary)]">Explore</h3>
            ...
            <div>
                <h3 className="text-sm font-semibold text-[color:var(--color-text-primary)]">For Restaurants</h3>
                <ul className="mt-5 space-y-3">
                <li>
                    <Link href={route('restaurant.register')} className="inline-flex items-center gap-1 text-sm text-[color:var(--color-text-secondary)] transition hover:text-[color:var(--color-primary-600)]">
                    Add Your Restaurant
                    <ArrowUpRight className="h-3.5 w-3.5" />
                    </Link>
                </li>
                <li>
                    <FooterLink href={route('restaurant.login')}>Restaurant Login</FooterLink>
                </li>
            ...
            {/* Support Section */}
            <div>
                <h3 className="text-sm font-semibold text-[color:var(--color-text-primary)]">Support</h3>
                <ul className="mt-5 space-y-3">
                <li>
